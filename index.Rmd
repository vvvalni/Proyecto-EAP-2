...
Finalmente, tras la observación del mapa, se puede ver una clara diferenciación de las Américas con el resto del mundo, siendo que, al parecer, es la región que sostiene una mejor performance a nivel general. Esto con excepción de El Salvador. 
...
mapa5 = ggplot(mapMUN3) +
  ...
  theme(plot.title = element_text(size = 20, hjust = 0.54, family = "Cormorant Garamond"))+
