...
mapa1 = ggplot(mapMUN2) +
  ...
  theme(plot.subtitle = element_text(size = 10, hjust = 0.6))
...
mapa4 = ggplot(mapMUN2) +
  ...
  scale_fill_viridis(option = "F",
                     name= "Índice") +
  labs(title ="Escaños Ocupados por Mujeres en el Parlamento - Mapeo Mundial", subtitle='Proporción de Escaños ocupados - 2019, OCDE', caption="Data: Banco Mundial. Gender Data Portal")+
  theme(plot.title = element_text(size = 15, hjust = 0.6))+
  theme(plot.subtitle = element_text(size = 10, hjust = 0.6))
