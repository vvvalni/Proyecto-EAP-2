...
mapa2 = ggplot(mapMUN2) +
  ...
  theme(plot.title = element_text(size = 15, hjust = 0.67))+
  theme(plot.subtitle = element_text(size = 10, hjust = 0.6))
...
mapa3 = ggplot(mapMUN2) +
  ...
  theme(plot.title = element_text(size = 15, hjust = 0.8))+
  theme(plot.subtitle = element_text(size = 10, hjust = 0.6))
...
mapa4 = ggplot(mapMUN2) +
  ...
  theme(plot.title = element_text(size = 15, hjust = 0.65))+
  theme(plot.subtitle = element_text(size = 10, hjust = 0.6))
...
mapa5 = ggplot(mapMUN3) +
  ...
  theme(plot.title = element_text(size = 15, hjust = 0.52))+
  theme(plot.subtitle = element_text(size = 10, hjust = 0.52))+
